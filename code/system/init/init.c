...
motor_dir_obj_t motor_left;
motor_dir_obj_t motor_right;
...
void system_init(void)
{
    ...
    motor_left = motor_dir_init(ATOM0_CH0_P22_1, P22_0, 10000, 500, -1);
    motor_right = motor_dir_init(ATOM0_CH4_P22_3, P22_2, 10000, 500, 1);
